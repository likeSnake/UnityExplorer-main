...
// Module: GameAssembly_Super_IBT.dll
// Module Base: 0x1AEB3672000
// m_BuffManager2 = 0x9320; // decimal: 37664 status=VERIFIED
//   klass=0x1AEB367AD60 slot=0x1AEB367B320 candidates=1 staticFieldsOffset=0xC0 staticFields=0x1AEB367B090 instanceOffset=0x0 instance=0x1AEB367B0B0 instanceKlass=0x1AEB367AD60
// m_TransparentTagHandler2 = 0x9328; // decimal: 37672 status=CLASS_ONLY
//   klass=0x1AEB367AEF0 slot=0x1AEB367B328 candidates=1 staticFieldsOffset=0xC0 staticFields=0x1AEB367B0D0 instanceOffset=0x8 instance=0x0 instanceKlass=0x0
// ==========================================

// ===== Offset.h Discovery Summary (v7) =====
// Active module: GameAssembly_Super_IBT.dll base=0x1AEB3672000 variant=Super/SuperIBT
...
// Offset::GameAssembly = 0x1AEB3672000; // status=RUNTIME_VA module base VA; changes on restart
...
// Offset::Base_WindowBase = NOT_LOADED; // status=NOT_LOADED other GameAssembly variant; this dump covers only GameAssembly_Super_IBT.dll
// Offset::m_GlobalTime = NOT_LOADED; // status=NOT_LOADED other GameAssembly variant; this dump covers only GameAssembly_Super_IBT.dll
// Offset::m_CharacterManager = NOT_LOADED; // status=NOT_LOADED other GameAssembly variant; this dump covers only GameAssembly_Super_IBT.dll
// Offset::m_UserDataManager = NOT_LOADED; // status=NOT_LOADED other GameAssembly variant; this dump covers only GameAssembly_Super_IBT.dll
// Offset::m_CharactorSync = NOT_LOADED; // status=NOT_LOADED other GameAssembly variant; this dump covers only GameAssembly_Super_IBT.dll
// Offset::m_EntityManager = NOT_LOADED; // status=NOT_LOADED other GameAssembly variant; this dump covers only GameAssembly_Super_IBT.dll
// Offset::m_BuffManager = NOT_LOADED; // status=NOT_LOADED other GameAssembly variant; this dump covers only GameAssembly_Super_IBT.dll
// Offset::m_TransparentTagHandler = NOT_LOADED; // status=NOT_LOADED other GameAssembly variant; this dump covers only GameAssembly_Super_IBT.dll
// Offset::Base_WindowBase2 = NOT_LOADED; // status=NOT_LOADED UnityPlayer module unavailable
...
// Offset::m_UserDataManager2 = NOT_FOUND; // status=NOT_FOUND class-not-found: .UserData
// Offset::m_CharactorSync2 = NOT_FOUND; // status=NOT_FOUND class-not-found: MobileNetwork.CharactorSync
// Offset::m_EntityManager2 = NOT_FOUND; // status=NOT_FOUND class-not-found: GameLogic.Common.GameEntity
// Offset::m_BuffManager2 = NOT_FOUND; // status=NOT_FOUND class-not-found: .BuffManager
// Offset::m_TransparentTagHandler2 = NOT_FOUND; // status=NOT_FOUND class-not-found: .TransparentTagHandler
// Offset::MemoryShockUnresolvedRva = 0x111; // status=CONFIG_CONSTANT application unresolved sentinel; not a discovered game RVA
// Offset::InitActorKitRefer = NOT_FOUND; // status=NOT_FOUND class-not-found: .TransparentTagHandler
...
// Offset::Il2CppClassMethodCountOffset = 0x120; // status=CALIBRATED runtime layout: cMethodCount
// Offset::Il2CppClassStaticFieldsOffset = 0xC0; // status=VERIFIED singleton instance klass back-reference
// Offset::Il2CppMethodPointerOffset = 0x0; // status=CALIBRATED runtime layout: mPtr
// Offset::Il2CppMethodNameOffset = 0x18; // status=CALIBRATED runtime layout: mName
// Offset::Il2CppMethodSlotOffset = 0x50; // status=CALIBRATED runtime layout: mSlot
// Offset::Il2CppMethodParameterCountOffset = 0x52; // status=CALIBRATED runtime layout: mParamCount
// Offset::Il2CppStaticInstanceOffset = NOT_FOUND; // status=NOT_FOUND class-not-found: .TransparentTagHandler
...
// Offset::MemoryShockTransparentTagHandlerActorKitOffset = NOT_FOUND; // status=NOT_FOUND class-not-found: .TransparentTagHandler
// Offset::MemoryShockTransparentTagHandlerCharacterManagerOffset = NOT_FOUND; // status=NOT_FOUND class-not-found: .TransparentTagHandler
...
// Offset::MemoryShockCacheDelayBreakTypeOffset = NOT_FOUND; // status=NOT_FOUND class-not-found: .ActionBreakData
...
// Offset::MemoryShockVirtualVtableSlotOffset = NOT_LOADED; // status=NOT_LOADED other GameAssembly variant; this dump covers only GameAssembly_Super_IBT.dll
...
// Offset::AnimPlayableCrossFadeInFixedTimeNormal = NOT_LOADED; // status=NOT_LOADED other GameAssembly variant; this dump covers only GameAssembly_Super_IBT.dll
// Offset::AnimPlayableCrossFadeInFixedTimeSuper = NOT_FOUND; // status=NOT_FOUND class-not-found: .AnimPlayable
...
// Offset::ActorModel.animClipName = NOT_FOUND; // status=NOT_FOUND class-not-found: .EventTrackSet
...
// Offset::ActorModel.ActorKitS.HitSimulate.ReactionType = NOT_FOUND; // status=NOT_FOUND class-not-found: .ActionHitSimulateData
// Offset::ActorModel.ActorKitS.HitSimulate.RangeReactionType = NOT_FOUND; // status=NOT_FOUND class-not-found: .ActionHitSimulateData
// Offset::ActorModel.ActorKitS.HitSimulate.ReactionExtraType = NOT_FOUND; // status=NOT_FOUND class-not-found: .ActionHitSimulateData
// Offset::ActorModel.ActorKitS.HitSimulate.endureLevel = NOT_FOUND; // status=NOT_FOUND class-not-found: .ActionHitSimulateData
// Offset::ActorModel.ActorKitS.HitSimulate.ActionDuration = NOT_FOUND; // status=NOT_FOUND class-not-found: .ActionHitSimulateData
// Offset::ActorModel.ActorKitS.HitSimulate.ReactionParryType = NOT_FOUND; // status=NOT_FOUND class-not-found: .ActionHitSimulateData
// Offset::ActorModel.ActorKitS.HitSimulate.XuListate = NOT_FOUND; // status=NOT_FOUND class-not-found: .SkillComboData
...
// Offset::ActorModel.AdventureRigS.Euler = NOT_FOUND; // status=NOT_FOUND class-not-found: .AdventureRig
...
// Inventory: total=221 resolved=10 other/unavailable=13 candidates=0 constants=2 unresolved/skipped=196
// ==========================================
...
// Class: <Module> 
// Namespace: 
// Instance: 0x1aeb367abd0
internal class <Module> // TypeDefIndex: 0
{}

// Class: Sample 
// Namespace: Test.Game
// Instance: 0x1aeb3679000
// RVA: 0x9318
// RVA: 37656
[Serializable]
public sealed class Sample : BaseClass, IFoo, IBar // TypeDefIndex: 1
{
	// Fields
	...
	// Methods:6
	// RVA: 0x1010 VA: 0x1aeb3673010
	public Int32 get_Count() { }
	// RVA: 0x1020 VA: 0x1aeb3673020
	public Void set_Count(Int32 p0) { }
	// RVA: 0x1000 VA: 0x1aeb3673000
	public Void .ctor() { }
	// RVA: 0x1030 VA: 0x1aeb3673030
	public Void DoWork(Int32 p0, ref Single p1, out Int32 p2) { }
	// RVA: 0x1040 VA: 0x1aeb3673040 Slot: 4
...
// Class: MyEnum 
// Namespace: Test.Game
// Instance: 0x1aeb3679660
public enum MyEnum // TypeDefIndex: 2
{
	// Fields
...
// Class: MyStruct 
// Namespace: Test.Game
// Instance: 0x1aeb36798c0
public struct MyStruct : IFoo, IBar // TypeDefIndex: 3
{
	// Fields
...
// Class: Arrays 
// Namespace: Test.Game
// Instance: 0x1aeb3679ad0
public class Arrays // TypeDefIndex: 4
{
	// Fields
...
// Class: Object 
// Namespace: System
// Instance: 0x1aeb36700c0
public class Object // TypeDefIndex: 5
{}

// Class: BaseClass 
// Namespace: Test.Game
// Instance: 0x1aeb3670250
public class BaseClass // TypeDefIndex: 6
{}

// Class: IFoo 
// Namespace: Test.Game
// Instance: 0x1aeb36703f0
public interface IFoo // TypeDefIndex: 7
{}

// Class: Extra1 
// Namespace: Test.Game
// Instance: 0x1aeb3679e50
public class Extra1 // TypeDefIndex: 8
{
	// Fields
	...
	// Methods:2
	// RVA: 0x1100 VA: 0x1aeb3673100
	public Void M1() { }
	// RVA: 0x1110 VA: 0x1aeb3673110
	public Void M2() { }
}

// Class: Extra2 
// Namespace: Test.Game
// Instance: 0x1aeb367a1a0
public class Extra2 // TypeDefIndex: 9
{
	// Fields
	public Int32 f1; // offset:0x10
	...
	// Methods:3
	// RVA: 0x1200 VA: 0x1aeb3673200
	public Void M1() { }
	// RVA: 0x1210 VA: 0x1aeb3673210
	public Void M2() { }
	// RVA: 0x1220 VA: 0x1aeb3673220
	public Void M3() { }
}

// Class: Extra3 
// Namespace: Test.Game
// Instance: 0x1aeb367a620
public class Extra3 // TypeDefIndex: a
{
	// Fields
	public Int32 f1; // offset:0x10
	public Int32 f2; // offset:0x14
	...
	// Methods:4
	// RVA: 0x1300 VA: 0x1aeb3673300
	public Void M1() { }
	// RVA: 0x1310 VA: 0x1aeb3673310
	public Void M2() { }
	// RVA: 0x1320 VA: 0x1aeb3673320
	public Void M3() { }
	// RVA: 0x1330 VA: 0x1aeb3673330
	public Void M4() { }
}

// Class: BuffManager 
// Namespace: 
// Instance: 0x1aeb367ad60
// RVA: 0x9320
// RVA: 37664
public class BuffManager // TypeDefIndex: b
{}

// Class: TransparentTagHandler 
// Namespace: 
// Instance: 0x1aeb367aef0
// RVA: 0x9328
// RVA: 37672
public class TransparentTagHandler // TypeDefIndex: c
{}

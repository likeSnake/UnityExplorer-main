...
Source: F:\gua\dump\dump2026.09.03.cs
...
|---|---|---|---|---|
| m_GlobalTime | .GameBaseObject -> TypeInfo RVA | 0xE644808 | 0xE644808 | SAME |
| m_CharacterManager | .CharacterManager -> TypeInfo RVA | 0xE642388 | 0xE642388 | SAME |
| m_UserDataManager | .UserData -> TypeInfo RVA | 0xE644068 | 0xE644068 | SAME |
| m_CharactorSync | MobileNetwork.CharactorSync -> TypeInfo RVA | 0xE606490 | 0xE606490 | SAME |
| m_EntityManager | GameLogic.Common.GameEntity -> TypeInfo RVA | 0xE643020 | 0xE643020 | SAME |
| m_BuffManager | .BuffManager ->  | NOT_FOUND | 0xE641868 | unresolved |
| m_TransparentTagHandler | .TransparentTagHandler ->  | NOT_FOUND | 0xE88A328 | unresolved |
| m_GlobalTime2 | .GameBaseObject ->  | OTHER_VARIANT | 0x3755D18 | unresolved |
| m_CharacterManager2 | .CharacterManager ->  | OTHER_VARIANT | 0x374C2B8 | unresolved |
| m_UserDataManager2 | .UserData -> battleData | OTHER_VARIANT | 0x3772EA8 | unresolved |
| m_CharactorSync2 | MobileNetwork.CharactorSync ->  | OTHER_VARIANT | 0x374C368 | unresolved |
| m_EntityManager2 | GameLogic.Common.GameEntity ->  | OTHER_VARIANT | 0x3755DD0 | unresolved |
| m_BuffManager2 | .BuffManager ->  | OTHER_VARIANT | 0x374AE20 | unresolved |
| m_TransparentTagHandler2 | .TransparentTagHandler ->  | OTHER_VARIANT | 0x376ABF8 | unresolved |
| InitActorKitRefer | .TransparentTagHandler ->  | NOT_FOUND | MemoryShockUnresolvedRva | unresolved |
...
| AnimPlayableCrossFadeInFixedTimeNormal | .AnimPlayable -> CrossFadeInFixedTime | 0x5975FF0 | 0x5811350 | CHANGED |
| AnimPlayableCrossFadeInFixedTimeSuper | .AnimPlayable -> CrossFadeInFixedTime | OTHER_VARIANT | 0x797D760 | unresolved |
| FlushState | .ActorKit -> FlushState | NOT_FOUND | 0x1D7BE0 | unresolved |
| CrossFadeInFixedTime | .AnimPlayable -> CrossFadeInFixedTime | 0x5975FF0 | AnimPlayableCrossFadeInFixedTimeNormal | SYMBOLIC_INITIALIZER |
| LocalGenRangeSingleData | .RangeAttackEmitter -> LocalGenRangeSingleData | 0x5B3DD70 | 0x111 | CHANGED |
...
| Il2CppList.Items | System.Collections.Generic.List`1 -> _items | NOT_FOUND | 0x10 | unresolved |
| Il2CppList.Size | System.Collections.Generic.List`1 -> _size | NOT_FOUND | 0x18 | unresolved |
...
| BattleItemData.listItems | System.Collections.Generic.List`1 -> _items | NOT_FOUND | 0x10 | unresolved |
| BattleItemData.listSize | System.Collections.Generic.List`1 -> _size | NOT_FOUND | 0x18 | unresolved |
...
Managed mappings: matched=153 missing/ambiguous=8 other-variant=8.

## 数值不符（列出 dump 原值；有效性看状态，禁止跨变体复制）

| 变量 | Offset.h 原值 | dump 值 | 依据 | 状态 |
|---|---|---|---|---|
| AnimPlayableCrossFadeInFixedTimeNormal | 0x5811350 | 0x5975FF0 | AnimPlayable -> CrossFadeInFixedTime | CHANGED |
| LocalGenRangeSingleData | 0x111 | 0x5B3DD70 | RangeAttackEmitter -> LocalGenRangeSingleData | CHANGED |

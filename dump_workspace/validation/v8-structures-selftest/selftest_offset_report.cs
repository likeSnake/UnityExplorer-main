...
// Active module: GameAssembly_Super.dll base=0x2C713340000 variant=Super/SuperIBT
...
// Offset::UnityPlayer = 0x2C713340000; // status=RUNTIME_VA module base VA; changes on restart
// Offset::GameAssembly = 0x2C713340000; // status=RUNTIME_VA module base VA; changes on restart
...
// Offset::m_UserDataManager2 = 0x180; // status=FOUND Class: UserData [TypeInfo RVA] slot=0x2C713340180 klass=0x2C7133608D0
...
// Offset::m_TransparentTagHandler2 = 0x100; // status=FOUND Class: TransparentTagHandler [TypeInfo RVA] slot=0x2C713340100 klass=0x2C713360560
// Offset::MemoryShockUnresolvedRva = 0x111; // status=CONFIG_CONSTANT application unresolved sentinel; not a discovered game RVA
// Offset::InitActorKitRefer = 0x100; // status=FOUND Class: TransparentTagHandler [TypeInfo RVA] slot=0x2C713340100 klass=0x2C713360560
...
// Offset::AnimPlayableCrossFadeInFixedTimeSuper = 0x10020; // status=FOUND Class: AnimPlayable->CrossFadeInFixedTime params=7 MethodInfo=0x2C7133611C0 VA=0x2C713350020 slot=0xFFFF
// Offset::FlushState = NOT_FOUND; // status=NOT_FOUND class-not-found: .ActorKit
// Offset::CrossFadeInFixedTime = 0x10020; // status=FOUND Class: AnimPlayable->CrossFadeInFixedTime params=7 MethodInfo=0x2C7133611C0 VA=0x2C713350020 slot=0xFFFF

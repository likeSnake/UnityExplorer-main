...
//   klass=0x2C71334AD60 slot=0x2C71334B320 candidates=1 staticFieldsOffset=0xC0 staticFields=0x2C71334B090 instanceOffset=0x0 instance=0x2C71334B0B0 instanceKlass=0x2C71334AD60
// m_TransparentTagHandler2 = 0x9328; // decimal: 37672 status=CLASS_ONLY
//   klass=0x2C71334AEF0 slot=0x2C71334B328 candidates=1 staticFieldsOffset=0xC0 staticFields=0x2C71334B0D0 instanceOffset=0x8 instance=0x0 instanceKlass=0x0
// ==========================================

// ===== Offset.h Discovery Summary (v7) =====
// Active module: GameAssembly_Super_IBT.dll base=0x2C713342000 variant=Super/SuperIBT
...
// Offset::m_BuffManager2 = 0x9320; // status=FOUND Class: BuffManager [TypeInfo RVA] slot=0x2C71334B320 klass=0x2C71334AD60
// Offset::m_TransparentTagHandler2 = 0x9328; // status=FOUND Class: TransparentTagHandler [TypeInfo RVA] slot=0x2C71334B328 klass=0x2C71334AEF0
// Offset::MemoryShockUnresolvedRva = 0x111; // status=CONFIG_CONSTANT application unresolved sentinel; not a discovered game RVA
// Offset::InitActorKitRefer = 0x9328; // status=FOUND Class: TransparentTagHandler [TypeInfo RVA] slot=0x2C71334B328 klass=0x2C71334AEF0

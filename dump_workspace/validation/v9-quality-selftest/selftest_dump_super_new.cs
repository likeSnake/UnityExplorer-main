...
//   klass=0x2012741AD60 slot=0x2012741B180 candidates=1 staticFieldsOffset=0xC0 staticFields=0x2012741B090 instanceOffset=0x0 instance=0x2012741B0B0 instanceKlass=0x2012741AD60
// m_TransparentTagHandler2 = 0x9188; // decimal: 37256 status=VERIFIED
//   klass=0x2012741AEF0 slot=0x2012741B188 candidates=1 staticFieldsOffset=0xC0 staticFields=0x2012741B0D0 instanceOffset=0x8 instance=0x2012741B0F0 instanceKlass=0x2012741AEF0
// ==========================================

// ===== Offset.h Discovery Summary (v7) =====
// Active module: GameAssembly_Super.dll base=0x20127412000 variant=Super/SuperIBT
...
// Offset::m_BuffManager2 = 0x9180; // status=FOUND Class: BuffManager [TypeInfo RVA] slot=0x2012741B180 klass=0x2012741AD60
// Offset::m_TransparentTagHandler2 = 0x9188; // status=FOUND Class: TransparentTagHandler [TypeInfo RVA] slot=0x2012741B188 klass=0x2012741AEF0
// Offset::MemoryShockUnresolvedRva = 0x111; // status=CONFIG_CONSTANT application unresolved sentinel; not a discovered game RVA
// Offset::InitActorKitRefer = 0x9188; // status=FOUND Class: TransparentTagHandler [TypeInfo RVA] slot=0x2012741B188 klass=0x2012741AEF0

...
// Module Base: 0x20127412000
// m_BuffManager2 = 0x9320; // decimal: 37664 status=VERIFIED
//   klass=0x2012741AD60 slot=0x2012741B320 candidates=1 staticFieldsOffset=0xC0 staticFields=0x2012741B090 instanceOffset=0x0 instance=0x2012741B0B0 instanceKlass=0x2012741AD60
// m_TransparentTagHandler2 = 0x9328; // decimal: 37672 status=CLASS_ONLY
//   klass=0x2012741AEF0 slot=0x2012741B328 candidates=1 staticFieldsOffset=0xC0 staticFields=0x2012741B0D0 instanceOffset=0x8 instance=0x0 instanceKlass=0x0
// ==========================================

// ===== Offset.h Discovery Summary (v7) =====
// Active module: GameAssembly_Super_IBT.dll base=0x20127412000 variant=Super/SuperIBT
...
// Offset::GameAssembly = 0x20127412000; // status=RUNTIME_VA module base VA; changes on restart
...
// Offset::m_BuffManager2 = 0x9320; // status=FOUND Class: BuffManager [TypeInfo RVA] slot=0x2012741B320 klass=0x2012741AD60
// Offset::m_TransparentTagHandler2 = 0x9328; // status=FOUND Class: TransparentTagHandler [TypeInfo RVA] slot=0x2012741B328 klass=0x2012741AEF0
// Offset::MemoryShockUnresolvedRva = 0x111; // status=CONFIG_CONSTANT application unresolved sentinel; not a discovered game RVA
// Offset::InitActorKitRefer = 0x9328; // status=FOUND Class: TransparentTagHandler [TypeInfo RVA] slot=0x2012741B328 klass=0x2012741AEF0
...
// Class: <Module> 
// Namespace: 
// Instance: 0x2012741abd0
internal class <Module> // TypeDefIndex: 0
{}

// Class: Sample 
// Namespace: Test.Game
// Instance: 0x20127419000
// RVA: 0x9318
// RVA: 37656
[Serializable]
public sealed class Sample : BaseClass, IFoo, IBar // TypeDefIndex: 1
{
	...
	// Methods:6
	// RVA: 0x1010 VA: 0x20127413010
	public Int32 get_Count() { }
	// RVA: 0x1020 VA: 0x20127413020
	public Void set_Count(Int32 p0) { }
	// RVA: 0x1000 VA: 0x20127413000
	public Void .ctor() { }
	// RVA: 0x1030 VA: 0x20127413030
	public Void DoWork(Int32 p0, ref Single p1, out Int32 p2) { }
	// RVA: 0x1040 VA: 0x20127413040 Slot: 4
...
public class Extra1 // TypeDefIndex: 8
{
	...
	// Methods:2
	// RVA: 0x1100 VA: 0x20127413100
	public Void M1() { }
	// RVA: 0x1110 VA: 0x20127413110
	public Void M2() { }
}

// Class: Extra2 
// Namespace: Test.Game
// Instance: 0x2012741a1a0
public class Extra2 // TypeDefIndex: 9
{
	...
	// Methods:3
	// RVA: 0x1200 VA: 0x20127413200
	public Void M1() { }
	// RVA: 0x1210 VA: 0x20127413210
	public Void M2() { }
	// RVA: 0x1220 VA: 0x20127413220
	public Void M3() { }
}

// Class: Extra3 
// Namespace: Test.Game
// Instance: 0x2012741a620
public class Extra3 // TypeDefIndex: a
{
	...
	// Methods:4
	// RVA: 0x1300 VA: 0x20127413300
	public Void M1() { }
	// RVA: 0x1310 VA: 0x20127413310
	public Void M2() { }
	// RVA: 0x1320 VA: 0x20127413320
	public Void M3() { }
	// RVA: 0x1330 VA: 0x20127413330
	public Void M4() { }
}

// Class: BuffManager 
// Namespace: 
// Instance: 0x2012741ad60
// RVA: 0x9320
// RVA: 37664

...
namespace Offset
{
	...
	inline uint64_t InitActorKitRefer = 0x376ABF8; // 运行时解析为 TransparentTagHandler TypeInfo RVA
	...
	inline uint64_t CrossFadeInFixedTime = 0x797D760;

	inline uint64_t LocalGenRangeSingleData = 0x5FECD50;  //追踪

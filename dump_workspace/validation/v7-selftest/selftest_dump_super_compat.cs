...
// m_TransparentTagHandler2 = NOT_FOUND; // reason=slot-not-found klass=0x17B533FAD10
// ==========================================
...
// Offset::m_TransparentTagHandler2 = NOT_FOUND; // status=NOT_FOUND TypeInfo slot-not-found: TransparentTagHandler
// Offset::MemoryShockUnresolvedRva = 0x111; // status=CONFIG_CONSTANT application unresolved sentinel; not a discovered game RVA
// Offset::InitActorKitRefer = NOT_FOUND; // status=NOT_FOUND TypeInfo slot-not-found: TransparentTagHandler
...
// Inventory: total=221 resolved=11 other/unavailable=13 candidates=0 constants=2 unresolved/skipped=195
// ==========================================

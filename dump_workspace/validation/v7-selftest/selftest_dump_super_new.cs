...
//   klass=0x17B533FAD60 slot=0x17B533FB180 candidates=1 staticFieldsOffset=0xC0 staticFields=0x17B533FB090 instanceOffset=0x0 instance=0x17B533FB0B0 instanceKlass=0x17B533FAD60
// m_TransparentTagHandler2 = 0x9188; // decimal: 37256 status=VERIFIED
//   klass=0x17B533FAEF0 slot=0x17B533FB188 candidates=1 staticFieldsOffset=0xC0 staticFields=0x17B533FB0D0 instanceOffset=0x8 instance=0x17B533FB0F0 instanceKlass=0x17B533FAEF0
// ==========================================

// ===== Offset.h Discovery Summary (v7) =====
// Active module: GameAssembly_Super.dll base=0x17B533F2000 variant=Super/SuperIBT
...
// Offset::m_BuffManager2 = 0x9180; // status=FOUND Class: BuffManager [TypeInfo RVA] slot=0x17B533FB180 klass=0x17B533FAD60
// Offset::m_TransparentTagHandler2 = 0x9188; // status=FOUND Class: TransparentTagHandler [TypeInfo RVA] slot=0x17B533FB188 klass=0x17B533FAEF0
// Offset::MemoryShockUnresolvedRva = 0x111; // status=CONFIG_CONSTANT application unresolved sentinel; not a discovered game RVA
// Offset::InitActorKitRefer = 0x9188; // status=FOUND Class: TransparentTagHandler [TypeInfo RVA] slot=0x17B533FB188 klass=0x17B533FAEF0

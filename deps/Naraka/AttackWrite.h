...
float 长剑A1后摇 = 0.355f;
float 长剑走A1后摇 = 0.355f;
float 长剑滑步A1后摇 = 0.338f;
float 长剑B1后摇 = 0.404f;
float 长剑走B1后摇 = 0.404f;
float 长剑滑步B1后摇 = 0.404f;
float 长剑A2后摇 = 0.644f;
float 长剑B2后摇 = 0.324f;
float 长剑CA后摇 = 0.504f;
float 长剑滑铲CA后摇 = 0.72f;
float 长剑升龙后摇 = 0.59f;
float 长剑滑铲升龙后摇 = 1.05f;
float 长剑跳A后摇 = 0.534f;
float 长剑下批后摇 = 0.635f;

float 太刀A1后摇 = 0.305f;
float 太刀走A1后摇 = 0.305f;
float 太刀滑步A1后摇 = 0.374f;
float 太刀B1后摇 = 0.324f;
float 太刀走B1后摇 = 0.324f;
float 太刀滑步B1后摇 = 0.374f;
float 太刀A2后摇 = 0.683f;
float 太刀B2后摇 = 0.593f;
float 太刀CA后摇 = 0.402f;
float 太刀滑铲CA后摇 = 1.111f;
float 太刀升龙后摇 = 0.604f;
float 太刀滑铲升龙后摇 = 0.8f;
float 太刀跳A后摇 = 0.503f;
float 太刀下批后摇 = 0.73f;
...
float 阔刀A1后摇 = 0.72f;
float 阔刀走A1后摇 = 0.72f;
float 阔刀滑步A1后摇 = 0.56f;
float 阔刀B1后摇 = 0.832f;
float 阔刀走B1后摇 = 0.832f;
float 阔刀滑步B1后摇 = 0.72f;
float 阔刀CA后摇 = 0.56f;
float 阔刀滑铲CA后摇 = 0.73f;
float 阔刀升龙后摇 = 0.39f;
float 阔刀滑铲升龙后摇 = 0.33f;
float 阔刀跳A后摇 = 0.71f;
float 阔刀下批后摇 = 0.78f;

float 长枪A1后摇 = 0.56f;
float 长枪走A1后摇 = 0.56f;
float 长枪滑步A1后摇 = 0.73f;
float 长枪B1后摇 = 0.42f;
float 长枪走B1后摇 = 0.42f;
float 长枪滑步B1后摇 = 0.53f;
float 长枪A2后摇 = 0.7f;
float 长枪B2后摇 = 0.96f;
float 长枪CA后摇 = 0.43f;
float 长枪滑铲CA后摇 = 0.89f;
float 长枪升龙后摇 = 0.79f;
float 长枪滑铲升龙后摇 = 0.79f;
float 长枪跳A后摇 = 0.4f;
float 长枪下批后摇 = 0.87f;

float 匕首A1后摇 = 0.3f;
float 匕首走A1后摇 = 0.3f;
float 匕首滑步A1后摇 = 0.35f;
float 匕首B1后摇 = 0.32f;
float 匕首走B1后摇 = 0.32f;
float 匕首滑步B1后摇 = 0.36f;
float 匕首A2后摇 = 0.56f;
float 匕首B2后摇 = 0.5f;
float 匕首CA后摇 = 0.57f;
float 匕首滑铲CA后摇 = 0.8f;
float 匕首升龙后摇 = 0.63f;
float 匕首滑铲升龙后摇 = 0.66f;
float 匕首跳A1后摇 = 0.42f;
float 匕首跳A2后摇 = 0.43f;
float 匕首下批后摇 = 0.86f;
...
float 双节棍A1后摇 = 0.4f;
float 双节棍走A1后摇 = 0.4f;
float 双节棍滑步A1后摇 = 0.42f;
float 双节棍B1后摇 = 0.32f;
float 双节棍走B1后摇 = 0.32f;
float 双节棍滑步B1后摇 = 0.35f;
float 双节棍A2后摇 = 0.86f;
float 双节棍B2后摇 = 0.57f;
float 双节棍CA后摇 = 0.5f;
float 双节棍滑铲CA后摇 = 0.5f;
float 双节棍升龙后摇 = 0.58f;
float 双节棍滑铲升龙后摇 = 0.65f;
float 双节棍跳A后摇 = 0.56f;
float 双节棍下批后摇 = 0.85f;

float 双刀A1后摇 = 0.3f;
float 双刀走A1后摇 = 0.3f;
float 双刀滑步A1后摇 = 0.33f;
float 双刀B1后摇 = 0.3f;
float 双刀走B1后摇 = 0.3f;
float 双刀滑步B1后摇 = 0.31f;
float 双刀A2后摇 = 0.78f;
float 双刀B2后摇 = 0.7f;
float 双刀CA后摇 = 0.47f;
float 双刀滑铲CA后摇 = 0.72f;
float 双刀升龙后摇 = 0.5f;
float 双刀滑铲升龙后摇 = 0.7f;
float 双刀跳A后摇 = 0.6f;
float 双刀下批后摇 = 0.8f;
...
float 双戟A1后摇 = 0.56f;
float 双戟走A1后摇 = 0.56f;
float 双戟滑步A1后摇 = 0.73f;
float 双戟B1后摇 = 0.42f;
float 双戟走B1后摇 = 0.42f;
float 双戟滑步B1后摇 = 0.53f;
float 双戟A2后摇 = 0.7f;
float 双戟B2后摇 = 0.96f;
float 双戟CA后摇 = 0.43f;
float 双戟滑铲CA后摇 = 0.89f;
float 双戟升龙后摇 = 0.79f;
float 双戟滑铲升龙后摇 = 0.79f;
float 双戟跳A后摇 = 0.4f;
float 双戟下批后摇 = 0.87f;

float 长棍A1后摇 = 0.56f;
float 长棍走A1后摇 = 0.56f;
float 长棍滑步A1后摇 = 0.73f;
float 长棍B1后摇 = 0.42f;
float 长棍走B1后摇 = 0.42f;
float 长棍滑步B1后摇 = 0.53f;
float 长棍A2后摇 = 0.7f;
float 长棍B2后摇 = 0.96f;
float 长棍CA后摇 = 0.43f;
float 长棍滑铲CA后摇 = 0.89f;
float 长棍升龙后摇 = 0.79f;
float 长棍滑铲升龙后摇 = 0.79f;
float 长棍跳A后摇 = 0.4f;
float 长棍下批后摇 = 0.87f;

float 斩马刀A1后摇 = 0.62f;
float 斩马刀走A1后摇 = 0.62f;
float 斩马刀滑步A1后摇 = 0.56f;
float 斩马刀B1后摇 = 0.732f;
float 斩马刀走B1后摇 = 0.732f;
float 斩马刀滑步B1后摇 = 0.62f;
float 斩马刀CA后摇 = 0.56f;
float 斩马刀滑铲CA后摇 = 0.63f;
float 斩马刀升龙后摇 = 0.39f;
float 斩马刀滑铲升龙后摇 = 0.33f;
float 斩马刀跳A后摇 = 0.71f;
float 斩马刀下批后摇 = 0.78f;

float 横刀A1后摇 = 0.305f;
float 横刀走A1后摇 = 0.305f;
float 横刀滑步A1后摇 = 0.374f;
float 横刀B1后摇 = 0.324f;
float 横刀走B1后摇 = 0.324f;
float 横刀滑步B1后摇 = 0.374f;
float 横刀A2后摇 = 0.683f;
float 横刀B2后摇 = 0.593f;
float 横刀CA后摇 = 0.402f;
float 横刀滑铲CA后摇 = 1.111f;
float 横刀升龙后摇 = 0.604f;
float 横刀滑铲升龙后摇 = 0.8f;
float 横刀跳A后摇 = 0.503f;
float 横刀下批后摇 = 0.73f;
...
float 扇子A1后摇 = 0.3f;
float 扇子走A1后摇 = 0.3f;
float 扇子滑步A1后摇 = 0.35f;
float 扇子B1后摇 = 0.32f;
float 扇子走B1后摇 = 0.32f;
float 扇子滑步B1后摇 = 0.36f;
float 扇子A2后摇 = 0.56f;
float 扇子B2后摇 = 0.5f;
float 扇子CA后摇 = 0.57f;
float 扇子滑铲CA后摇 = 0.8f;
float 扇子升龙后摇 = 0.63f;
float 扇子滑铲升龙后摇 = 0.66f;
float 扇子跳A1后摇 = 0.42f;
float 扇子跳A2后摇 = 0.43f;
float 扇子下批后摇 = 0.86f;
...
float 拳刃A1后摇 = 0.3f;
float 拳刃走A1后摇 = 0.3f;
float 拳刃滑步A1后摇 = 0.35f;
float 拳刃B1后摇 = 0.32f;
float 拳刃走B1后摇 = 0.32f;
float 拳刃滑步B1后摇 = 0.36f;
float 拳刃A2后摇 = 0.56f;
float 拳刃B2后摇 = 0.5f;
float 拳刃CA后摇 = 0.57f;
float 拳刃滑铲CA后摇 = 0.8f;
float 拳刃升龙后摇 = 0.63f;
float 拳刃滑铲升龙后摇 = 0.66f;
float 拳刃跳A1后摇 = 0.42f;
float 拳刃跳A2后摇 = 0.43f;
float 拳刃下批后摇 = 0.56f;
...
float 飞刀A1后摇 = 0.3f;
float 飞刀走A1后摇 = 0.3f;
float 飞刀滑步A1后摇 = 0.35f;
float 飞刀B1后摇 = 0.32f;
float 飞刀走B1后摇 = 0.32f;
float 飞刀滑步B1后摇 = 0.36f;
float 飞刀A2后摇 = 0.56f;
float 飞刀B2后摇 = 0.5f;
float 飞刀CA后摇 = 0.57f;
float 飞刀滑铲CA后摇 = 0.8f;
float 飞刀升龙后摇 = 0.63f;
float 飞刀滑铲升龙后摇 = 0.66f;
float 飞刀跳A1后摇 = 0.42f;
float 飞刀跳A2后摇 = 0.43f;
float 飞刀下批后摇 = 0.56f;
...
auto SwAttack(PlayerData obj, float 招式前摇)
{
	...
	if (Function::LogicKnife::BlueAttacklanding && LocalPlayer_Data.敌人数量5M内 <= 1)
	{
...
auto KatanaAttack(PlayerData obj, float 招式前摇)
{
	auto O_NameHash = mem.Read<unsigned int>(obj.Cache_NameHash + 0x18);
	...
	MyLog("老版本时间：", Global::WorldPtr.GlobalTime);
	auto ObjCurTime =(Global::WorldPtr.GlobalTime -mem.Read<double>(obj.Cache_GetCurTimeForLogicState_PTR + Offset::ActorModel.currentTime));
	if (Function::LogicKnife::BlueAttacklanding == true && LocalPlayer_Data.敌人数量5M内 <= 1)
	{
		if (出招后摇 != 0 && ObjCurTime > 出招后摇 / 3 && (flag ? true : LocalPlayer_Data.MyEndureLevel == 20 && LocalPlayer_Data.MyBlueTime <= 0.49))
		{
			MyLog("太刀蓝顶");
...
auto BladeAttack(PlayerData obj, float 招式前摇)
{
	auto O_NameHash = mem.Read<unsigned int>(obj.Cache_NameHash + 0x18);
	float 出招后摇 = 0.f;
	//站A1
...
auto SpearAttack(PlayerData obj, float 招式前摇)
{
	auto O_NameHash = mem.Read<unsigned int>(obj.Cache_NameHash + 0x18);
	float 出招后摇 = 0.f;
	//站A1
...
auto DaggeAttack(PlayerData obj, float 招式前摇)
{
	auto O_NameHash = mem.Read<unsigned int>(obj.Cache_NameHash + 0x18);
	float 出招后摇 = 0.f;
	//站A1
...
auto nunchucksAttack(PlayerData obj, float 招式前摇)
{
	auto O_NameHash = mem.Read<unsigned int>(obj.Cache_NameHash + 0x18);
	float 出招后摇 = 0.f;
	//站A1
...
auto twinbladesAttack(PlayerData obj, float 招式前摇)
{
	auto O_NameHash = mem.Read<unsigned int>(obj.Cache_NameHash + 0x18);
	float 出招后摇 = 0.f;
	//站A1
...
auto rodAttack(PlayerData obj, float 招式前摇)
{
	auto O_NameHash = mem.Read<unsigned int>(obj.Cache_NameHash + 0x18);
	float 出招后摇 = 0.f;
	//站A1
...
auto SaberAttack(PlayerData obj, float 招式前摇)
{
	auto O_NameHash = mem.Read<unsigned int>(obj.Cache_NameHash + 0x18);
	float 出招后摇 = 0.f;
	//站A1
...
auto dualhalberdAttack(PlayerData obj, float 招式前摇)
{
	auto O_NameHash = mem.Read<unsigned int>(obj.Cache_NameHash + 0x18);
	float 出招后摇 = 0.f;
	//站A1
...
auto fanAttack(PlayerData obj, float 招式前摇)
{
	auto O_NameHash = mem.Read<unsigned int>(obj.Cache_NameHash + 0x18);
	float 出招后摇 = 0.f;
	// 扇子吹风
...
auto hengdaoAttack(PlayerData obj, float 招式前摇)
{
	auto O_NameHash = mem.Read<unsigned int>(obj.Cache_NameHash + 0x18);
	float 出招后摇 = 0.f;
	//站A1
...
auto punchAttack(PlayerData obj, float 招式前摇)
{
	auto O_NameHash = mem.Read<unsigned int>(obj.Cache_NameHash + 0x18);
	float 出招后摇 = 0.f;
	//站A1
...
auto KnifeAttack(PlayerData obj, float 招式前摇)
{
	auto O_NameHash = mem.Read<unsigned int>(obj.Cache_NameHash + 0x18);
	float 出招后摇 = 0.f;
	//站A1
...
//长剑
auto SwBlueAttackWrite(PlayerData obj)
{
	...
	case 101:
		...
		break;
	case 102:
		KatanaAttack(obj, 自身出蓄前摇);
		break;
	case 103:
		BladeAttack(obj, 自身出蓄前摇);
		break;
	case 105:
		SpearAttack(obj, 自身出蓄前摇);
		break;
	case 106:
		DaggeAttack(obj, 自身出蓄前摇);
		break;
	case 116:
		nunchucksAttack(obj, 自身出蓄前摇);
		break;
	case 118:
		twinbladesAttack(obj, 自身出蓄前摇);
		break;
	case 119:
		SaberAttack(obj, 自身出蓄前摇);
		break;
	case 120:
		rodAttack(obj, 自身出蓄前摇);
		break;
	case 121:
		dualhalberdAttack(obj, 自身出蓄前摇);
		break;
	case 122:
		fanAttack(obj, 自身出蓄前摇);
		break;
	case 123:
		hengdaoAttack(obj, 自身出蓄前摇);
		break;
	case 124:
		punchAttack(obj, 自身出蓄前摇);
		break;
	case 127:
		KnifeAttack(obj, 自身出蓄前摇);
		break;
	default:
		break;
	}
...
//太刀
auto KatanaBlueAttackWrite(PlayerData obj)
{
...
//阔刀
auto BladeBlueAttackWrite(PlayerData obj)
{
...
//长枪
auto SpearBlueAttackWrite(PlayerData obj)
{
...
//匕首
auto DaggeBlueAttackWrite(PlayerData obj)
{
...
//双节棍
auto nunchucksBlueAttackWrite(PlayerData obj)
{
...
//双刀
auto twinbladesBlueAttackWrite(PlayerData obj)
{
...
//长棍
auto rodBlueAttackWrite(PlayerData obj)
{
...
//斩马刀
auto SaberBlueAttackWrite(PlayerData obj)
{
...
//双戟
auto dualhalberdBlueAttackWrite(PlayerData obj)
{
...
//扇子
auto fanBlueAttackWrite(PlayerData obj)
{
...
//横刀
auto hengdaoBlueAttackWrite(PlayerData obj)
{
...
//拳刃
auto punchBlueAttackWrite(PlayerData obj)
{
...
//飞刀
auto knifeBlueAttackWrite(PlayerData obj)
{
...
//出蓄抓白刀
auto BlueAttackWriteA(PlayerData obj)
{

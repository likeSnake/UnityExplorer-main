...
//   klass=0x1AEB367A9B0 slot=0x1AEB367AD50 candidates=1 staticFieldsOffset=0xB8 staticFields=0x1AEB367AC60 instanceOffset=0x0 instance=0x1AEB367AC80 instanceKlass=0x1AEB367A9B0
// m_TransparentTagHandler = 0x8D58; // decimal: 36184 status=VERIFIED
//   klass=0x1AEB367AB00 slot=0x1AEB367AD58 candidates=1 staticFieldsOffset=0xB8 staticFields=0x1AEB367ACA0 instanceOffset=0x8 instance=0x1AEB367ACC0 instanceKlass=0x1AEB367AB00
// ==========================================

// ===== Offset.h Discovery Summary (v7) =====
// Active module: GameAssembly.dll base=0x1AEB3672000 variant=Normal
...
// Offset::m_CharactorSync = NOT_FOUND; // status=NOT_FOUND class-not-found: MobileNetwork.CharactorSync
// Offset::m_EntityManager = NOT_FOUND; // status=NOT_FOUND class-not-found: GameLogic.Common.GameEntity
// Offset::m_BuffManager = NOT_FOUND; // status=NOT_FOUND class-not-found: .BuffManager
// Offset::m_TransparentTagHandler = NOT_FOUND; // status=NOT_FOUND class-not-found: .TransparentTagHandler
...
// Offset::MemoryShockVirtualVtableSlotOffset = NOT_FOUND; // status=NOT_FOUND class-not-found: .TransparentTagHandler
...
// Inventory: total=221 resolved=10 other/unavailable=12 candidates=0 constants=2 unresolved/skipped=197
// ==========================================
